...
const HomePage = () => (
  <div>
    <h1>Home</h1>
    <p>
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit in magnam odio unde vitae.
      At commodi corporis delectus dolorem exercitationem expedita facilis optio quia, quis quisquam
      rem repellendus vitae, voluptatibus.
    </p>
    <p>
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias blanditiis ducimus laudantium
      nesciunt placeat? Amet cupiditate deleniti dolor earum eos harum iure libero, nesciunt quos
      sequi soluta voluptate. Culpa, incidunt.
    </p>
    <p>
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. A ad, aliquid animi blanditiis
      consequuntur, delectus eum fugiat impedit nihil odit quam rem saepe tempora ullam vel. Aliquid
